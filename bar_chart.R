...
p <- ggplot2::ggplot(anim_table_deaths_city, aes(rank)) +
  ...
  ggplot2::labs(
    title = "Covid-19: Óbitos Acumulados Capitais", x = "", y = "",
...
p <- ggplot2::ggplot(anim_table_deaths_mg, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Minas Gerais", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_to, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Tocantins", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_se, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Sergipe", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_confirmed_sp, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Casos Acumulados: São Paulo ", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_sp, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: São Paulo", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_sc, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Santa Catarina", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_rr, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Roraima", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_ro, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Rondonia", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_rs, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Rio Grande do Sul", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_rn, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Rio Grande do Norte", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_rj, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Rio de Janeiro", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_confirmed_pi, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Casos Acumulados: Piauí ", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_pi, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Piauí", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_pe, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Pernambuco", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_confirmed_pr, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Casos Acumulados: Paraná ", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_pr, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Paraná", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_confirmed_pb, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Casos Acumulados: Paraíba ", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_pb, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Paraíba", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_confirmed_pa, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Casos Acumulados: Pará ", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_pa, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Pará", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_ms, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Mato Grosso do Sul", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_mt, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Mato Grosso", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_confirmed_ma, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Casos Acumulados: Maranhão ", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_ma, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Maranhão", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_confirmed_go, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Casos Acumulados: Goiás ", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_go, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Goiás", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_confirmed_es, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Casos Acumulados: Espírito Santo ", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_es, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Espírito Santo", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_df, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Distrito Federal", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_confirmed_ce, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Casos Acumulados: Ceará ", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_ce, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Ceará", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_ba, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Bahia", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_am, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Amazonas", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_confirmed_ap, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Casos Acumulados: Amapá ", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_ap, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Amapá", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_ac, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Acre", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_al, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Alagoas", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_confirmed_ro, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Casos Acumulados: Rondônia", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
...
p <- ggplot2::ggplot(anim_table_deaths_ro, aes(rank)) +
  ...
  ggplot2::guides(color = FALSE, fill = FALSE) +
  ggplot2::labs(
    title = "Covid-19 Óbitos Acumulados: Rondônia", x = "", y = "",
    subtitle = "{closest_state}",
    caption = "Dados: SES via https://data.brasil.io/. Elaborado: Rede Análise COVID-19 por Vinícius Godinho"
  ) +
  ggplot2::theme(title = element_text(size=30),
